...
public class NMSProxyWorldServer extends net.minecraft.server.a1_1_2_1.ee implements Runnable {
	...
	@Override
	public net.minecraft.server.a1_1_2_1.as k(int x, int y, int z) {
		Block block = world.getBlockAt(x, y, z);
		...
		if (blockState instanceof CreatureSpawner) {
			...
			net.minecraft.server.a1_1_2_1.hb chest = new net.minecraft.server.a1_1_2_1.hb();
			chest.a = this;
			return chest;
		} else {
	...
	public int d(int x, int z) {
		...
		while (y > 0) {
			int type = a(x, y, z);
			if (type == 0 || (!net.minecraft.server.a1_1_2_1.ff.n[type].bn.c() && !net.minecraft.server.a1_1_2_1.ff.n[type].bn.d())) {
				y--;
			} else {
				return y + 1;
			}
	...
	@Override
	public int a(net.minecraft.server.a1_1_2_1.cy paramcy, int x, int y, int z) {
		// dummy - seems to have something to do with lighting
		return 0;
	}
	
	@Override
	public void a(net.minecraft.server.a1_1_2_1.cy paramcy, int x, int y, int z, int arg4) {
		// dummy - seems to have something to do with lighting
	}
	
	@Override
	public boolean a(net.minecraft.server.a1_1_2_1.dj paramdj) {
		// dummy
		return false;
	}

	@Override
	public void b(int arg0, int arg1, int arg2, net.minecraft.server.a1_1_2_1.as arg3) {
